...
# 3. Print the hard evidence
cat("Expected max_time: 365\n")
cat("Actual end_time:  ", summary_data$end_time, "\n")
cat("Final I_total:    ", tail(traj$I_total, 1), "\n")
cat("Status message:   ", summary_data$status, "\n\n")
