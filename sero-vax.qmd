...
In an open population model, when the birth rate or migration is very high (higher than the rate of depletion), the denominator increase faster and make the attack rate drops.
